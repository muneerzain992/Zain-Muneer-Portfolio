...
const projects = [
  ...
  },
  {
    ...
    outcomes: [
      ...
      'Engineered a multi-stage Meta Ads lead acquisition funnel, implementing precise custom audience segmentation, lookalike data matrices, and systematic A/B split-testing to slash Cost Per Lead (CPL) and maximize Return on Ad Spend (ROAS).',
      'Integrated deep web analytics and conversion rate optimization (CRO) frameworks using Meta Events Manager to monitor full-funnel customer behavior (CTR, CPC, CPA) and systematically eliminate checkout friction points.'
    ],
    technologies: ['React.js', 'Vite', 'Tailwind CSS', 'Framer Motion / GSAP', 'Meta Ads Manager', 'Meta Events Manager', 'Advanced A/B Testing', 'Custom/Lookalike Audiences', 'Conversion Rate Optimization (CRO)', 'Copywriting & Positioning', 'Vercel', 'Git'],
  },
  {
            ...
            <div key={index} className="projects__card reveal">
              ...
              <div className="projects__card-right">
                ...
                <div className="projects__actions">
                  ...
                  <div className="projects__buttons" style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
                    {project.liveLink && (
                      <a 
